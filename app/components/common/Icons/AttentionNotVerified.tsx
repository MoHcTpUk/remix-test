...
function SvgAttentionNotVerified(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width={24}
      height={24}
    ...
    >
      ...
      <path
        ...
        strokeLinejoin='round'
      />
      <path d='M12.5 16a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0Z' fill='#fff' stroke='#FFF4E5' />
    </svg>
  );
}
export default SvgAttentionNotVerified;
