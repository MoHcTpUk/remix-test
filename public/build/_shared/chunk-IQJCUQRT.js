...
function createRouter(init2) {
  ...
  let initialized = (
    ...
    (!initialMatches.some((m) => m.route.loader) || init2.hydrationData != null)
  );
  let router2;
  let state = {
  ...
  async function startRedirectNavigation(state2, redirect3, _temp) {
    ...
    if (ABSOLUTE_URL_REGEX.test(redirect3.location) && isBrowser2) {
      let url = init2.history.createURL(redirect3.location);
  ...
  async function callLoadersAndMaybeResolveData(currentMatches, matches, matchesToLoad, fetchersToLoad, request) {
    let results = await Promise.all([...matchesToLoad.map((match) => callLoaderOrAction("loader", request, match, matches, manifest, mapRouteProperties2, basename)), ...fetchersToLoad.map((f) => {
      if (f.matches && f.match && f.controller) {
        return callLoaderOrAction("loader", createClientSideRequest(init2.history, f.path, f.controller.signal), f.match, f.matches, manifest, mapRouteProperties2, basename);
      } else {
        let error = {
          type: ResultType.error,
...
var init_router = __esm({
  "node_modules/@remix-run/router/dist/router.js"() {
    ...
    json = function json2(data, init2) {
      if (init2 === void 0) {
        init2 = {};
      }
    ...
    defer = function defer2(data, init2) {
      if (init2 === void 0) {
        init2 = {};
      }
      let responseInit = typeof init2 === "number" ? {
    ...
    redirect = function redirect2(url, init2) {
      if (init2 === void 0) {
        init2 = 302;
      }
...
// node_modules/@remix-run/react/node_modules/react-router-dom/node_modules/react-router/dist/index.js
var dist_exports = {};
...
async function fetchData(request, routeId, retry = 0) {
  ...
  if (request.method !== "GET") {
    init2.method = request.method;
    let contentType = request.headers.get("Content-Type");
    if (contentType && /\bapplication\/json\b/.test(contentType)) {
      init2.headers = {
        "Content-Type": contentType
      };
      init2.body = JSON.stringify(await request.json());
    } else if (contentType && /\btext\/plain\b/.test(contentType)) {
      init2.headers = {
        "Content-Type": contentType
      };
      init2.body = await request.text();
    } else if (contentType && /\bapplication\/x-www-form-urlencoded\b/.test(contentType)) {
      init2.body = new URLSearchParams(await request.text());
    } else {
      init2.body = await request.formData();
    }
  }
  if (retry > 0) {
  ...
  let response = await fetch(url.href, init2).catch((error) => {
...
var import_react2, defaultOptions, i18nInstance, I18nContext, ReportNamespaces, initReactI18next;
...
function warnOnce() {
  ...
  if (typeof args[0] === "string" && alreadyWarned3[args[0]])
    return;
  if (typeof args[0] === "string")
    alreadyWarned3[args[0]] = /* @__PURE__ */ new Date();
...
function hasValidReactChildren(children) {
  ...
  return children.every(function(child) {
    return (0, import_react4.isValidElement)(child);
  });
}
...
function nodesToString(children, i18nOptions) {
  ...
  childrenArray.forEach(function(child, childIndex) {
    if (typeof child === "string") {
    ...
    } else if ((0, import_react4.isValidElement)(child)) {
      ...
      var format = child.format, clone = _objectWithoutProperties(child, _excluded4);
...
function renderNodes(children, targetString, i18n, i18nOptions, combinedTOpts, shouldUnescape) {
  ...
  function getData(childs) {
    ...
    childrenArray.forEach(function(child) {
      ...
      else if (_typeof(child) === "object" && !(0, import_react4.isValidElement)(child))
  ...
  function pushTranslatedJSX(child, inner, mem, i2, isVoid) {
    ...
    mem.push((0, import_react4.cloneElement)(child, _objectSpread2(_objectSpread2({}, child.props), {}, {
      key: i2
    }), isVoid ? void 0 : inner));
  }
  function mapAST(reactNode, astNode, rootReactNode) {
    ...
    return astNodes.reduce(function(mem, node, i2) {
      ...
      if (node.type === "tag") {
        ...
        var isElement = (0, import_react4.isValidElement)(child);
        ...
        if (typeof child === "string") {
          ...
          if (isKnownComponent) {
            ...
            if (node.voidElement) {
              mem.push((0, import_react4.createElement)(node.name, {
        ...
        if (wrapTextNodes) {
          mem.push((0, import_react4.createElement)(wrapTextNodes, {
            key: "".concat(node.name, "-").concat(i2)
          }, _content));
        } else {
          mem.push(_content);
...
function Trans(_ref) {
  ...
  return useAsParent ? (0, import_react4.createElement)(useAsParent, additionalProps, content) : content;
}
var import_react4, _excluded4, _excluded22;
var init_Trans = __esm({
  "node_modules/react-i18next/dist/es/Trans.js"() {
    ...
    init_utils();
    _excluded4 = ["format"];
    _excluded22 = ["children", "count", "parent", "i18nKey", "context", "tOptions", "values", "defaults", "components", "ns", "i18n", "t", "shouldUnescape"];
  }
});
...
function useTranslation(ns) {
  ...
  var _ref = (0, import_react5.useContext)(I18nContext) || {}, i18nFromContext = _ref.i18n, defaultNSFromContext = _ref.defaultNS;
  var i18n = i18nFromProps || i18nFromContext || getI18n();
  ...
  var _useState = (0, import_react5.useState)(getT), _useState2 = _slicedToArray(_useState, 2), t2 = _useState2[0], setT = _useState2[1];
  var joinedNS = namespaces.join();
  var previousJoinedNS = usePrevious(joinedNS);
  var isMounted = (0, import_react5.useRef)(true);
  ...
  var isInitial = (0, import_react5.useRef)(true);
  (0, import_react5.useEffect)(function() {
...
function withTranslation(ns) {
  ...
  return function Extend(WrappedComponent) {
    function I18nextWithTranslation(_ref) {
      var forwardedRef = _ref.forwardedRef, rest = _objectWithoutProperties(_ref, _excluded5);
      ...
      return (0, import_react6.createElement)(WrappedComponent, passDownProps);
    }
    I18nextWithTranslation.displayName = "withI18nextTranslation(".concat(getDisplayName(WrappedComponent), ")");
    I18nextWithTranslation.WrappedComponent = WrappedComponent;
    var forwardRef3 = function forwardRef4(props, ref) {
      return (0, import_react6.createElement)(I18nextWithTranslation, Object.assign({}, props, {
        forwardedRef: ref
      }));
    };
    return options.withRef ? (0, import_react6.forwardRef)(forwardRef3) : I18nextWithTranslation;
  };
}
var import_react6, _excluded5;
...
function Translation(props) {
  var ns = props.ns, children = props.children, options = _objectWithoutProperties(props, _excluded6);
...
function withSSR() {
  return function Extend(WrappedComponent) {
    function I18nextWithSSR(_ref) {
      ...
      return (0, import_react8.createElement)(WrappedComponent, _objectSpread5({}, rest));
    }
...
@remix-run/react/dist/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-IQJCUQRT.js.map
